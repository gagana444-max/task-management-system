...
const CARD_COLORS = [
  { bg: 'linear-gradient(145deg, #ffffff 0%, #f9fafb 100%)', accent: '#000000', border: '#e5e7eb', iconBg: '#000000', dot1: '#4b5563', dot2: '#d1d5db', text: '#000000' }, // White
  { bg: 'linear-gradient(145deg, #f9fafb 0%, #f3f4f6 100%)', accent: '#111827', border: '#d1d5db', iconBg: '#111827', dot1: '#374151', dot2: '#9ca3af', text: '#111827' }, // Off White
  { bg: 'linear-gradient(145deg, #f3f4f6 0%, #e5e7eb 100%)', accent: '#1f2937', border: '#d1d5db', iconBg: '#1f2937', dot1: '#111827', dot2: '#6b7280', text: '#1f2937' }, // Light Gray
  { bg: 'linear-gradient(145deg, #ffffff 0%, #f4f4f5 100%)', accent: '#27272a', border: '#e4e4e7', iconBg: '#27272a', dot1: '#52525b', dot2: '#d4d4d8', text: '#27272a' }, // Zinc
  { bg: 'linear-gradient(145deg, #fafafa 0%, #f5f5f5 100%)', accent: '#171717', border: '#e5e5e5', iconBg: '#171717', dot1: '#404040', dot2: '#d4d4d4', text: '#171717' }, // Neutral
]
